...
if (strpos($userAgent, 'Android') !== false || strpos($userAgent, 'iPhone') !== false || strpos($userAgent, 'iPad') !== false || strpos($userAgent, 'iPod') !== false || strpos($userAgent, 'Tablet') !== false) {$android = "<br>";}else{$android = "<br><br><br><br>";}
...
<body class="vertical-layout" data-color="bg-gradient-x-purple-blue">
    ...
    <div class="content-wrapper">
                ...
                <div class="mt-2"></div>
                        ...
                        <div class="col-md-8"><br><br><br><br>
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <textarea rows="5" style="resize: none; color: #fff;" class="form-control text-center form-checker mb-2" placeholder="Insira sua Lista aqui" title="Insira sua Lista aqui"></textarea>
                                    <div class="input-group mb-1">
                                        <input type="text" style="text-align: center;" class="form-control" id="chavetoken" placeholder="COOKIE, TOKEN OU CHAVE">&nbsp;       
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="float-right">
                                    <button type='show' class="btn btn-primary btn-sm show-dies"><i class="fa fa-eye"></i></button>
        ...
        <div class="text-center" style="text-align: center; justify-content: center; margin-top: 35px;">
            <p style="text-align: center; justify-content: center; color: white; font-size: 17px; cursor: pointer;" id="link"><font color='yellow'>🌙 China</font>Developer</p>
        </div>
    </div>
