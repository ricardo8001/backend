...
// Função para consultar informações do BIN
function bin($cartao) {
    ...
    $response = json_decode($fim, true)["response"];
    $bandeira = strtoupper($response["vendor"]);
    $tipo = strtoupper($response["card_type"]);
    $nivel = strtoupper($response["level"]);
    $banco = strtoupper($response["issuer"]);
    $pais = strtoupper($response["country_code"]);
    return "$bandeira - $tipo - $nivel - $banco - $pais";
}
?>
<!DOCTYPE html>
<html lang="pt">
        ...
        $(document).ready(function() {
            ...
            $('#start').click(function() {
                ...
                function processLine(index) {
                    ...
                    let cardInfo = '<?php echo bin("'+bin+'"); ?>'; // Chama a função bin() para obter informações do cartão
                    ...
                    let callBack = $.ajax({
                        ...
                        success: function(retorno) {
                            ...
                            let formattedRetorno = retorno.replace('Aprovada', '<font color="green">Aprovada</font>')
